    ...
    <>
     ...
     <div className="w-full  flex justify-center items-center h-[70vh]">
        <div className="flex flex-col justify-center items-center space-x-4 w-[80%] md:w-[25%]">
            ...
            <input type="text" className="w-full mt-2 px-4 py-2 border-2 border-black outline-0" placeholder="Enter Your Name"/>
            ...
            <button className="w-full mt-2 px-4 py-4 text-lg font-bold text-white bg-black hover:bg-gray-500 rounded">Register</button>
